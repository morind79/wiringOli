...
static int pinToGpio[128] =
{
  ...
  SUNXI_GPI(0), SUNXI_GPI(1), SUNXI_GPI(2), SUNXI_GPI(3), SUNXI_GPI(10), SUNXI_GPI(11),      // GPIO-2 (27 I/O pins)
  ...
  SUNXI_GPH(0), SUNXI_GPH(2), SUNXI_GPH(7), SUNXI_GPH(9), SUNXI_GPH(10), SUNXI_GPH(11),      // GPIO-3 (36 I/O pins)
