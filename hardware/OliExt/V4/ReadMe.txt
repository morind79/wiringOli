...
2 - Change Uart4 to Uart3 and add CTS/RTS signals (Uart 0, 2, 3, 4, 6, 7 are used) Using SubD9 Female and see as DTE
...
6 - Fix issues on SIM 900 module RI, RXT and TXD are 2.8V signal, and TXS0104 because TXB0104 is not good for UART 